...
public class User {
    ...
    //konstruktorius RegisterActivity (registruojant naują vartotoją)
    ...
    //konstruktorius, skirtas prisijungimo langui LoginActivity
    public User(Context context){
        this.sharedPreferences = context.getSharedPreferences(User.PREFERENCES_FILE_NAME, Context.MODE_PRIVATE);
    }

    //geteriai, seteriai, skirti LoginActivity prisijungimo langui
    ...
    //geteriai, seteriai, skirti registracijai (RegisterActivity)
